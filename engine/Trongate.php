...
class Trongate {
    ...
    public function __get(string $key): object {
        ...
        // TODO: if we want non-shared instances, use $this->memo instead
        if ($memo = memo($key)) {
            return $memo;
        }
        ...
        try {
            ...
            // TODO: we're swallowing *any* error from module resolution
     ...
     *
     * @template T of Trongate
     * @param class-string<T> $target_module The name of the target module.
     * @return T
     */
