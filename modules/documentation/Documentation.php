...
class Documentation extends Trongate {
    ...
    public function display_table_of_contents(array $data): void {
    	$chapters = $this->db->get_chapters(segment(2));
    ...
    public function display_chapter_intro_page(array $data): void {
    	...
    	$current_chapter_obj = $this->db->get_current_chapter($chapter_url_string, $chapters);
        ...
        $next_prev_array = $this->db->build_prev_next_array($current_chapter_obj, $chapters, $data);
    ...
    public function display_docs_page(array $data): void {
    	...
    	$current_page_obj = $this->db->get_current_page($page_url_string, $current_chapter_obj);
