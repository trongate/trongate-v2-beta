<section class="force_tall">
    <div class="container container-xs">
        ...
        echo validation_errors('offer_value');
        echo form_number('offer_value', $offer_value, array('placeholder' => 'Enter the amount that you are asking for...'));

        echo form_label('Your Preferred Currency:');
        echo validation_errors('offer_currency');
        echo form_input('offer_currency', $offer_currency, array('placeholder' => 'Enter the currency that you would like to be paid in...'));

        echo form_label('Your Special Terms: <span>optional</span>');
        echo form_textarea('comment', $comment, array('placeholder' => 'Use this space to enter any special terms that you have...', 'rows' => 7));
