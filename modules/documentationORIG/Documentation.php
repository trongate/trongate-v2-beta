...
class Documentation extends Trongate {
    ...
    public function display_chapter_intro_page($data) {
        ...
        $current_chapter = $this->model->extract_current_chapter($data);
        $data['current_chapter_number'] = (int) $current_chapter->chapter_number;
        $data['current_chapter_title'] = $current_chapter->chapter_title;
        ...
        $data['breadcrumbs'] = [
            ...
            ['title' => 'Documentation', 'url' => BASE_URL . 'documentation'],
            ['title' => $first_chapter->book_title, 'url' => BASE_URL . 'documentation/'.segment(2)],
            ['title' => 'This Chapter Title', 'url' => current_url()]
        ];
    ...
    private function which_method() {
        ...
        if (($target_method !== 'table_of_contents') && (segment(4) === '')) {
